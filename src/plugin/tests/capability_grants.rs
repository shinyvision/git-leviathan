//! capability grant acceptance tests: & security UI.
//!
//! Each test cites the acceptance-criterion bullet from the plan
//! (`PLUGIN_REFACTOR.md` capability grants, lines ~578-627). Required tests
//! covered (see brief):
//!
...
fn audit_log_contains_grant_lifecycle_codes() {
    ...
    // under the canonical capability grant codes (`grant.allowed`,
