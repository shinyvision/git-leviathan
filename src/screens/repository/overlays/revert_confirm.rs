...
pub(crate) fn is_in_place_button(button_id: &DialogButtonId) -> bool {
    button_id.0 == IN_PLACE_BUTTON_ID
}
...
pub(crate) fn is_write_button_action(dialog_id: &DialogId, button_id: &DialogButtonId) -> bool {
    dialog_id.0 == DIALOG_ID && (is_immediate_button(button_id) || is_in_place_button(button_id))
}
