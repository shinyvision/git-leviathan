//! Detail panel — right column showing commit metadata, message (or reword
//! editor), file list, and diff summary. Owns the dirty-commit message
//! editor, reword editor, and the copied-SHA tooltip flash; panel width and
//! resize activity live in `RepositoryData::resize`.
