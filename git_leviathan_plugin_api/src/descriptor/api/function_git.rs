...
pub(super) const REPOSITORY_FUNCTIONS: &[ApiFunction] = &[
    ...
    ApiFunction {
        ...
        since: "1.0",
        compatibility: "v1",
        doc: "Return up to `limit` commits from the active repository as `LeviathanCommit` rows.",
        params: &[ApiParam {
            name: "opts",
            lua_type: "table",
            required: false,
        ...
        returns: &[
            ApiReturn { lua_type: "LeviathanCommit[]|nil", doc: "Commit list on success." },
            ApiReturn { lua_type: "string|nil", doc: "Error message on failure." },
        ],
    ...
    ApiFunction {
        ...
        since: "1.0",
        compatibility: "v1",
        doc: "Return per-file diff for `commit`. The result carries `commit` as `LeviathanCommit`.",
        params: &[ApiParam {
            name: "opts",
            lua_type: "table",
            required: true,
            doc: "Options table: { commit = LeviathanCommit }.",
        }],
        returns: &[
            ApiReturn { lua_type: "LeviathanCommitDiff|nil", doc: "Diff snapshot on success." },
            ApiReturn { lua_type: "string|nil", doc: "Error message on failure." },
        ],
    ...
    ApiFunction {
        ...
        since: "1.0",
        compatibility: "v1",
        doc: "Return the file at a given commit/path. The result carries `commit` as `LeviathanCommit`.",
        params: &[ApiParam {
            name: "opts",
            lua_type: "table",
            required: true,
            doc: "Options table: { commit = LeviathanCommit, path = \"src/main.rs\" }.",
        }],
        returns: &[
            ApiReturn { lua_type: "LeviathanCommitFile|nil", doc: "File-at-commit snapshot on success." },
            ApiReturn { lua_type: "string|nil", doc: "Error message on failure." },
        ],
